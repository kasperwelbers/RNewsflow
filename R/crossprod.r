...
#'
#' tcrossprod with benefits. Enables filtering the results on the fly, to 
...
tcrossprod_sparse <- function(m, m2=NULL, min_value=NULL, max_value=NULL, only_upper=F, diag=T, top_n=NULL, rowsum_div=F, normalize=c('none','l2','softl2'), crossfun=c('prod','min','softprod'), group=NULL, group2=NULL, date=NULL, date2=NULL, lwindow=-1, rwindow=1, date_unit=c('days','hours','minutes','seconds'), simmat=NULL, simmat_thres=NULL, batchsize=1000, verbose=F) {
  ...
  cp = batched_tcrossprod_cpp(m, m2, group1=group, group2=group2, order1=order1, order2=order2, simmat=simmat, 
                              ...
                              rowsum_div=rowsum_div, normalize=normalize, crossfun=crossfun,
