...
batched_tcrossprod_cpp <- function(m1, m2, group1, group2, order1, order2, use_threshold = TRUE, min_value = 0, top_n = 0L, diag = TRUE, only_upper = FALSE, rowsum_div = FALSE, l2norm = FALSE, crossfun = "prod", lwindow = 0L, rwindow = 0L, verbose = FALSE, batchsize = 1000L) {
