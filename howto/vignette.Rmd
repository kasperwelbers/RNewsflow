...
For the current data, we use this to set a minimum time distance of 6 hours for document pairs where the `to` document is from a print newspaper. 
...
To make this more convenient, we also offer the `plot.aggregate.network` function. 
