...
\NormalTok{permed.g1 =}\StringTok{ }\KeywordTok{aggregate.network}\NormalTok{(g, }\DataTypeTok{by.from=}\StringTok{'source'}\NormalTok{, }\DataTypeTok{by.to=}\StringTok{'source'}\NormalTok{, }
                              \DataTypeTok{return.network =} \NormalTok{T, }\DataTypeTok{network.edge.weight =} \StringTok{'from.prop'}\NormalTok{)}
\NormalTok{permed.g2 =}\StringTok{ }\KeywordTok{aggregate.network}\NormalTok{(g2, }\DataTypeTok{by.from=}\StringTok{'source'}\NormalTok{, }\DataTypeTok{by.to=}\StringTok{'source'}\NormalTok{, }
                              \DataTypeTok{return.network =} \NormalTok{T, }\DataTypeTok{network.edge.weight =} \StringTok{'from.prop'}\NormalTok{)}

\NormalTok{permed.g1 =}\StringTok{ }\KeywordTok{delete.edges}\NormalTok{(permed.g1, }\KeywordTok{which}\NormalTok{(}\KeywordTok{E}\NormalTok{(permed.g1)$weight <}\StringTok{ }\FloatTok{0.05}\NormalTok{))}
\NormalTok{permed.g2 =}\StringTok{ }\KeywordTok{delete.edges}\NormalTok{(permed.g2, }\KeywordTok{which}\NormalTok{(}\KeywordTok{E}\NormalTok{(permed.g2)$weight <}\StringTok{ }\FloatTok{0.05}\NormalTok{))}

\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(permed.g1, }\DataTypeTok{layout=}\NormalTok{layout.circle, }\DataTypeTok{vertex.label.dist=}\FloatTok{0.6}\NormalTok{, }\DataTypeTok{edge.label.cex =} \FloatTok{0.7}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(permed.g2, }\DataTypeTok{layout=}\NormalTok{layout.circle, }\DataTypeTok{vertex.label.dist=}\FloatTok{0.6}\NormalTok{, }\DataTypeTok{edge.label.cex =} \FloatTok{0.7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
