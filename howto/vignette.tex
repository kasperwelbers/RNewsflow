...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(g.agg, }\DataTypeTok{layout=}\NormalTok{layout.circle, }\DataTypeTok{edge.width =} \KeywordTok{E}\NormalTok{(g.agg)$from.V_prop*}\DecValTok{10}\NormalTok{, }
             \DataTypeTok{edge.curved=}\FloatTok{0.2}\NormalTok{, }\DataTypeTok{vertex.label.dist=}\FloatTok{0.6}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{plot}\NormalTok{(g2.agg, }\DataTypeTok{layout=}\NormalTok{layout.circle, }\DataTypeTok{edge.width =} \KeywordTok{E}\NormalTok{(g2.agg)$from.V_prop*}\DecValTok{10}\NormalTok{, }
             \DataTypeTok{edge.curved=}\FloatTok{0.2}\NormalTok{, }\DataTypeTok{vertex.label.dist=}\FloatTok{0.6}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# Aggregate and visualize network }
\NormalTok{g.agg =}\StringTok{ }\KeywordTok{aggregate.network}\NormalTok{(g, }\DataTypeTok{by=}\StringTok{'source'}\NormalTok{, }\DataTypeTok{edge.attribute=}\StringTok{'hourdiff'}\NormalTok{, }\DataTypeTok{agg.FUN=}\NormalTok{median)}

\KeywordTok{get.adjacency}\NormalTok{(g.agg, }\DataTypeTok{attr=}\StringTok{'from.V_prop'}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(g.agg, }\DataTypeTok{layout=}\NormalTok{layout.circle, }\DataTypeTok{edge.width =} \KeywordTok{E}\NormalTok{(g.agg)$from.V_prop*}\DecValTok{10}\NormalTok{, }
             \DataTypeTok{edge.curved=}\FloatTok{0.2}\NormalTok{, }\DataTypeTok{vertex.label.dist=}\FloatTok{0.6}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
